...
# Full Tunnel or Split Tunnel IPv6 + IPv4 Wireguard VPN connections to an ad blocking Adguard server, from your Android, iOS, Chrome OS, Linux, macOS, & Windows devices
...
While Adguard was originally authored to run on a Raspberry Pi, people have followed this guide to deploy securely hosted instances of Adguard with VPN only access on Google Cloud, AWS, Heroku, Azure, Linode, Digital Ocean, Oracle Cloud, and on spare hardware at home.
...
2.  Download and execute **setup.sh** from this repository to:
    ...
    2.  install the latest Adguard, and configure it to accept DNS requests from the Wireguard interface
...
```bash
sudo su -
curl -O https://raw.githubusercontent.com/sfdcai/adguard-wireguard/master/setup.sh
chmod +x setup.sh
bash ./setup.sh 
```
...
<table>
    <tbody>
        <tr>
            <td><b><a href="#option-a--set-up-a-Adguard-ad-blocking-vpn-server-with-a-static-anycast-ip-on-google-clouds-always-free-usage-tier">Option&nbsp;A</a></b></td>
            <td>
                Set up a Adguard Ad Blocking VPN Server with a static Anycast IP on Google Cloud's Always Free Usage Tier.<br><br>
        ...
        <tr>
            <td><b><a href="#option-b--set-up-a-Adguard-ad-blocking-vpn-server-behind-your-router-at-home">Option&nbsp;B</a></b></td>
            <td>Set up a Adguard Ad Blocking VPN Server behind your router at home.</td>
        </tr>
    </tbody>
</table>
...
### OPTION A <br> Set up a Adguard Ad Blocking VPN Server with a static Anycast IP on Google Cloud's Always Free Usage Tier
...
### OPTION B <br> Set up a Adguard Ad Blocking VPN Server behind your router at home.
...
- **STEP 3** [Enable DNS over HTTPS](https://docs.Adguard.net/guides/dns-over-https/)
...
Please review the [Issues](https://github.com/rajannpatel/Adguard-on-Google-Compute-Engine-Free-Tier-with-Full-Tunnel-and-Split-Tunnel-Wireguard-VPN-Configs/issues) if you are in a position to help others, or participate in improving this project.
